@extends('layouts.app', ['title' => __('Ubah Alat')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Ubah Alat') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" class="form-bahan" action="{{ route('alat.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
