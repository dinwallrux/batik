                ...
                <div class="col-lg-8">
                    ...
                    <div class="card wish-list mb-4">
                        <div class="card-body">
                            ...
                            <h5 class="mb-4">Cart (<span>{{ $totalItem }}</span> Barang)</h5>
                            @if (session()->get('cart'))
                                                ...
                                                <div class="col-md-7 col-lg-9 col-xl-9">
                                                    <div>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="form-group row mb-0">
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        {{ App\Obat::where('id', $type['color'])->get()->first()->hasil }}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-lg-12">
                                                                        <label class="form-control-label" for="input-harga">{{ __('Jenis Kain :') }}</label>
                                                                        {{ isset($type['jenis_kain']) ? $type['jenis_kain'] : "" }}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <form action="{{ route('cart.update', [$type['id'], $type['color']]) }}">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="def-number-input number-input safari_only mb-0 w-100">
                                                                            ...
                                                                            <input class="quantity" min="0" name="quantity" value="{{ $type['quantity'] }}" type="number">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <form action="{{ route('cart.delete', [$type['id'], $type['color'], $type['jenis_kain']]) }}">
